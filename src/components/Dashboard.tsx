...
const Dashboard = () => {
  ...
  const [currentltydeleting , setCurrentlyDeleting] = useState<string | null> (null)
              ...
              >
                ...
                <div className="px-6 mt-4 grid  grid-cols-3 place-items-center py-2 gap-6 text-xs text-zinc-500">
                  ...
                  size="sm" className="w-full" variant="destructive">
                    {currentltydeleting === file.id ? (<Loader2 className="h-4 w-4 animate-spin"/>):<Trash className="h-4 w-4" />}
                  </Button>
                </div>
              </li>
            ))}
